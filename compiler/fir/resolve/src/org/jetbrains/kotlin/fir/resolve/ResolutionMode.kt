...
fun ResolutionMode.fullyExpandedClassFromExpectedTypeIfAny(components: BodyResolveComponents, session: FirSession): FirRegularClass? =
    expectedType(components)?.coneTypeOrNull?.fullyExpandedType(session)
